        ...
        <div class="col-md-6">
          ...
          <form class="mt-4" v-on:submit.prevent>
            ...
            <div class="form-group">
                ...
                <textarea v-model="pesan.keterangan" class="form-control" placeholder="Keterangan : Pedes , Nasi Setengah"></textarea>
            </div>
...
axios
.post("https://my-json-server.typicode.com/aditcahyono19/katalogmenu/keranjangs", this.pesan)
.then (() => {
